...
public:
	...
	std::string getGEOJSONcompact(bool full = false);
	std::string getGEOJSONtiny(bool full = false);
	std::string getship2JSON(bool full = false);
	std::string getGEOJSONmini(bool full = false);	
	std::string getJSONfive(bool full = false);
	
	// add by 230618
	std::string getJSON6SHIP_M(bool full = false); // add moving ship layer
	std::string getJSON5SHIP_A(bool full = false);
	std::string getJSON_STATION(bool full = false);
	std::string getJSON_ATON(bool full = false);
	std::string getJSON_SAR(bool full = false);
	std::string getJSON_SG(bool full = false);
	std::string getJSON_AIS_SART(bool full = false);
	std::string getJSON_USO(bool full = false);
	// add by 230624
	std::string getJSON_ship7(bool full = false);
